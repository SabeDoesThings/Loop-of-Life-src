...
package body Working is
   ...
   begin
      ...
      SDL.Images.IO.Create (BG_Surf, "res/office2.png");
      ...
      Text_Surf := Font.Render_Solid (Text => "8 hours later..", Colour => SDL.Video.Palettes.Colour'(Red => 255, Green => 255, Blue => 255, Alpha => 255));
      SDL.Video.Textures.Makers.Create (Text_Text, Ren, Text_Surf);

      Load_MUS ("res/sound2.mp3", Music);
      Play (Music, 0);
   end Init;
